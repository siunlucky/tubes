...
func dummyData() {
	worldBank.Banks[0].name = "Bank A"
	worldBank.Banks[0].uniqueCode = 123
	worldBank.Banks[0].nBranch = 2
	...
	dummyCustomers[0] = Customer{
		...
		branchAddress: Address{district: "Dist1", city: "City1", province: "Prov1"}, isSuspended: false,
	}
	dummyCustomers[1] = Customer{
		...
		branchAddress: Address{district: "Dist2", city: "City2", province: "Prov2"}, isSuspended: false,
	}
	dummyCustomers[2] = Customer{
		accountNumber: 1003, balance: 0, PIN: "123456", NIK: 1234567890123453, name: "Dummy3",
		address: Address{district: "Dist3", city: "City3", province: "Prov3"}, bankCode: 789,
		branchAddress: Address{district: "Dist3", city: "City3", province: "Prov3"}, isSuspended: false,
	}
	dummyCustomers[3] = Customer{
		...
		branchAddress: Address{district: "Dist4", city: "City4", province: "Prov4"}, isSuspended: false,
	}
	dummyCustomers[4] = Customer{
		...
		branchAddress: Address{district: "Dist5", city: "City5", province: "Prov5"}, isSuspended: false,
	}
